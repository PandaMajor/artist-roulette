  ...
  export default function Header() {
    return (
      <div className="container flex flex-row mx-auto h-44">
        <div className="container flex flex-col justify-center mx-auto sm:flex-row xl:mx-52">
            <div className="container flex flex-row items-center justify-center mt-4 space-x-2 xl:justify-start xl:mt-0">
                <Image src={Vinyl} alt='Vinyl icon' />
                <a className="text-2xl font-playfair hover:text-slate-900/80" href="#">ARTIST ROULETTE</a>
            </div>
            <div className="container flex flex-row justify-center py-4 space-x-16 xl:justify-end xl:py-0">
                ...
                <div className="container flex flex-row items-center justify-end text-base max-w-fit">
                    <button className="container flex flex-row items-center justify-center space-x-1 border rounded-md border-slate-800/70 py-2 xl:py-2.5 max-w-fit px-5 bg-white/90 shadow-black/40 shadow-md hover:bg-blueberry">
